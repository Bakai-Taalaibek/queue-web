...
var require_jspdf_html2canvas_min = __commonJS({
  "node_modules/jspdf-html2canvas/dist/jspdf-html2canvas.min.js"(exports, module) {
    !function(t, e) {
      "object" == typeof exports && "object" == typeof module ? module.exports = e(require_html2canvas(), (init_jspdf_es_min(), __toCommonJS(jspdf_es_min_exports))) : "function" == typeof define && define.amd ? define(["html2canvas", "jspdf"], e) : "object" == typeof exports ? exports["jspdf-html2canvas"] = e(require_html2canvas(), (init_jspdf_es_min(), __toCommonJS(jspdf_es_min_exports))) : t.html2PDF = e(t.html2canvas, t.jspdf);
    }(window, function(t, e) {
      return function(t2) {
        var e2 = {};
        function r(n) {
        ...
        function r(t3, e3, r2, n, o, i, a) {
          try {
            var c = t3[i](a), u = c.value;
          } catch (t4) {
            return void r2(t4);
          }
          c.done ? e3(u) : Promise.resolve(u).then(n, o);
        }
        t2.exports = function(t3) {
          return function() {
            var e3 = this, n = arguments;
        ...
        function r(e3) {
          return "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? t2.exports = r = function(t3) {
            return typeof t3;
        ...
        var n = function(t3) {
          "use strict";
          var e3 = Object.prototype, r2 = e3.hasOwnProperty, n2 = "function" == typeof Symbol ? Symbol : {}, o = n2.iterator || "@@iterator", i = n2.asyncIterator || "@@asyncIterator", a = n2.toStringTag || "@@toStringTag";
          function c(t4, e4, r3) {
          ...
          function u(t4, e4, r3, n3) {
            var o2 = e4 && e4.prototype instanceof l ? e4 : l, i2 = Object.create(o2.prototype), a2 = new P(n3 || []);
            return i2._invoke = function(t5, e5, r4) {
              ...
              return function(o3, i3) {
                ...
                for (r4.method = o3, r4.arg = i3; ; ) {
                  ...
                  var u2 = f(t5, e5, r4);
                  if ("normal" === u2.type) {
                    if (n4 = r4.done ? "completed" : "suspendedYield", u2.arg === s)
                      continue;
            ...
            this._invoke = function(o2, i2) {
              function a2() {
                return new e4(function(n4, a3) {
                  !function n5(o3, i3, a4, c2) {
                    var u2 = f(t4[o3], t4, i3);
                    if ("throw" !== u2.type) {
                      var s2 = u2.arg, l2 = s2.value;
                      return l2 && "object" == typeof l2 && r2.call(l2, "__await") ? e4.resolve(l2.__await).then(function(t5) {
                        n5("next", t5, a4, c2);
                      }, function(t5) {
                        n5("throw", t5, a4, c2);
          ...
          function b(t4, e4) {
            ...
            if (void 0 === r3) {
              if (e4.delegate = null, "throw" === e4.method) {
                if (t4.iterator.return && (e4.method = "return", e4.arg = void 0, b(t4, e4), "throw" === e4.method))
                  return s;
                e4.method = "throw", e4.arg = new TypeError("The iterator does not provide a 'throw' method");
              }
              return s;
            }
            var n3 = f(r3, t4.iterator, e4.arg);
            if ("throw" === n3.type)
              return e4.method = "throw", e4.arg = n3.arg, e4.delegate = null, s;
            var o2 = n3.arg;
            return o2 ? o2.done ? (e4[t4.resultName] = o2.value, e4.next = t4.nextLoc, "return" !== e4.method && (e4.method = "next", e4.arg = void 0), e4.delegate = null, s) : o2 : (e4.method = "throw", e4.arg = new TypeError("iterator result is not an object"), e4.delegate = null, s);
          }
          function x(t4) {
            var e4 = { tryLoc: t4[0] };
          ...
          return p.prototype = y.constructor = h, h.constructor = p, p.displayName = c(h, a, "GeneratorFunction"), t3.isGeneratorFunction = function(t4) {
            var e4 = "function" == typeof t4 && t4.constructor;
            return !!e4 && (e4 === p || "GeneratorFunction" === (e4.displayName || e4.name));
          }, t3.mark = function(t4) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t4, h) : (t4.__proto__ = h, c(t4, a, "GeneratorFunction")), t4.prototype = Object.create(y), t4;
          }, t3.awrap = function(t4) {
            return { __await: t4 };
          }, v(w.prototype), w.prototype[i] = function() {
            return this;
          }, t3.AsyncIterator = w, t3.async = function(e4, r3, n3, o2, i2) {
            void 0 === i2 && (i2 = Promise);
            var a2 = new w(u(e4, r3, n3, o2), i2);
            return t3.isGeneratorFunction(r3) ? a2 : a2.next().then(function(t4) {
              return t4.done ? t4.value : a2.next();
            });
          }, v(y), c(y, a, "Generator"), y[o] = function() {
            return this;
          }, y.toString = function() {
          ...
          }, t3.values = k, P.prototype = { constructor: P, reset: function(t4) {
            if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = false, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(j), !t4)
              for (var e4 in this)
            ...
            return a2.type = t4, a2.arg = e4, i2 ? (this.method = "next", this.next = i2.finallyLoc, s) : this.complete(a2);
          }, complete: function(t4, e4) {
            if ("throw" === t4.type)
              throw t4.arg;
            return "break" === t4.type || "continue" === t4.type ? this.next = t4.arg : "return" === t4.type ? (this.rval = this.arg = t4.arg, this.method = "return", this.next = "end") : "normal" === t4.type && e4 && (this.next = e4), s;
          }, finish: function(t4) {
            for (var e4 = this.tryEntries.length - 1; e4 >= 0; --e4) {
              var r3 = this.tryEntries[e4];
              if (r3.finallyLoc === t4)
                return this.complete(r3.completion, r3.afterLoc), j(r3), s;
            }
          }, catch: function(t4) {
            for (var e4 = this.tryEntries.length - 1; e4 >= 0; --e4) {
              var r3 = this.tryEntries[e4];
            ...
            return this.delegate = { iterator: k(t4), resultName: e4, nextLoc: r3 }, "next" === this.method && (this.arg = void 0), s;
          } }, t3;
        }(t2.exports);
        try {
        ...
        "use strict";
        r.r(e2);
        var n = r(0), o = r.n(n), i = r(2), a = r.n(i), c = r(3), u = r(1), f = r.n(u), s = { jsPDF: { unit: "px", format: "a4" }, html2canvas: { imageTimeout: 15e3, logging: true, useCORS: false }, margin: { right: 0, top: 0, bottom: 0, left: 0 }, imageType: "image/jpeg", imageQuality: 1, output: "jspdf-generate.pdf", init: function() {
        }, success: function(t3) {
          t3.save(this.output);
        } }, l = r(4), p = r.n(l);
        function h(t3) {
          return null !== t3 && "object" === p()(t3);
        }
        function d(t3) {
          return "function" == typeof t3;
        }
        function g(t3, e3) {
          for (var r2 = 0, n2 = Object.keys(t3); r2 < n2.length; r2++) {
            var o2 = n2[r2];
            if (o2 in e3) {
              var i2 = h(t3[o2]), a2 = h(e3[o2]);
              i2 && a2 ? d(t3[o2]) && d(e3[o2]) ? d(t3[o2]) && !d(e3[o2]) ? console.error('[jspdf-html2canvas] config key "'.concat(o2, '" type invalid')) : t3[o2] = e3[o2] : t3[o2] = g(t3[o2], e3[o2]) : a2 ? (e3[o2].old = t3[o2], t3[o2] = e3[o2]) : i2 ? t3[o2].new = e3[o2] : t3[o2] = e3[o2], delete e3[o2];
            }
          }
          return Object.assign(t3, e3);
        }
        function m(t3) {
          var e3 = t3.margin, r2 = new c.jsPDF(t3.jsPDF), n2 = r2.internal.pageSize.getWidth(), o2 = r2.internal.pageSize.getHeight();
          return { pdf: r2, pdfWidth: n2, pdfHeight: o2, pdfContentWidth: n2 - (e3.left + e3.right), pdfContentHeight: o2 - (e3.top + e3.bottom), position: 0, currentPage: 1, pageOfCurrentNode: 1 };
        }
        function y(t3, e3, r2) {
          var n2 = e3.pdf, o2 = e3.pdfContentWidth, i2 = e3.pdfContentHeight, a2 = e3.pdfWidth, c2 = e3.pdfHeight, u2 = e3.position, f2 = e3.currentPage, s2 = e3.pageOfCurrentNode, l2 = function(t4) {
            var e4 = t4.canvas, r3 = t4.pdf, n3 = t4.pdfContentWidth, o3 = t4.opts, i3 = e4.toDataURL(o3.imageType, o3.imageQuality), a3 = r3.getImageProperties(i3);
            return { pageData: i3, imgHeight: n3 / a3.width * a3.height };
          }({ canvas: t3, pdf: n2, pdfContentWidth: o2, opts: r2 }), p2 = l2.pageData, h2 = l2.imgHeight, d2 = h2;
          u2 < 0 && (n2.addPage(), f2 += 1, s2 = 1, u2 = 0);
          for (var g2 = r2.margin; d2 > 0; ) {
            if (n2.addImage(p2, { "image/jpeg": "JPEG", "image/png": "PNG", "image/webp": "WEBP" }[r2.imageType], g2.left, u2 + g2.top * s2 + g2.bottom * (s2 - 1), o2, h2), n2.setFillColor(255, 255, 255), n2.rect(0, 0, a2, g2.top, "F"), n2.rect(0, c2 - g2.bottom, a2, g2.bottom, "F"), d2 < i2) {
              u2 -= d2;
              break;
            }
            d2 -= i2, u2 -= c2, n2.addPage(), f2 += 1, s2 += 1;
          }
          return e3.pdf = n2, e3.position = u2, e3.currentPage = f2, e3.pageOfCurrentNode = s2, { pdf: n2, position: u2 };
        }
        function v(t3, e3) {
          var r2 = t3.internal.getNumberOfPages();
          if (e3.watermarkImg)
            for (var n2 = t3.getImageProperties(e3.watermarkImg), o2 = e3.watermark.scale || 1, i2 = 1; i2 <= r2; i2++)
              if (t3.setPage(i2), e3.watermark.src && e3.watermark.handler) {
                var a2 = { pdf: t3, pageNumber: i2, totalPageNumber: r2, imgNode: e3.watermarkImg };
                e3.watermark.handler.call(e3, a2);
              } else
                t3.addImage(e3.watermarkImg, "PNG", (t3.internal.pageSize.width - n2.width * o2) / 2, (t3.internal.pageSize.height - n2.height * o2) / 2, n2.width * o2, n2.height * o2);
          else if ("function" == typeof e3.watermark)
            for (var c2 = 1; c2 <= r2; c2++) {
              t3.setPage(c2);
              var u2 = { pdf: t3, pageNumber: c2, totalPageNumber: r2 };
              e3.watermark.call(e3, u2);
            }
          else
        ...
        function w(t3, e3) {
          var r2 = new Image(), n2 = "string" == typeof t3.watermark ? t3.watermark : t3.watermark.src;
          n2 ? (r2.onload = function() {
            e3(r2);
          }, r2.crossOrigin = "Anonymous", r2.src = n2) : e3();
        }
        function b() {
          return (b = a()(o.a.mark(function t3(e3) {
            var r2, n2, i2, a2 = arguments;
            return o.a.wrap(function(t4) {
              for (; ; )
                switch (t4.prev = t4.next) {
                  case 0:
                    if (r2 = a2.length > 1 && void 0 !== a2[1] ? a2[1] : {}, r2 = g(s, r2), n2 = m(r2), r2.init.call(r2, n2.pdf), !e3.length) {
                      t4.next = 16;
                      break;
                    }
                    i2 = 0;
                  case 6:
                    ...
                    return t4.next = 9, f()(e3[i2], r2.html2canvas);
                  case 9:
                    y(t4.sent, n2, r2);
                  case 11:
                    i2++, t4.next = 6;
                  ...
                  case 14:
                    ...
                    break;
                  case 16:
                    return t4.next = 18, f()(e3, r2.html2canvas);
                  case 18:
                    y(t4.sent, n2, r2);
                  case 20:
                    return r2.watermark ? w(r2, function(t5) {
                      t5 && (r2.watermarkImg = t5), n2.pdf = v(n2.pdf, r2), r2.success.call(r2, n2.pdf);
                    }) : r2.success.call(r2, n2.pdf), t4.abrupt("return", n2.pdf);
                  case 22:
                  case "end":
                    return t4.stop();
                }
...
export default require_jspdf_html2canvas_min();
...
html2canvas/dist/html2canvas.js:
  ...
  (*! *****************************************************************************
      ...
      ***************************************************************************** *)
*/
//# sourceMappingURL=jspdf-html2canvas.js.map
